...
const std::map<date, std::vector<solution>>& solutions()
{
    ...
    static const std::map<date, std::vector<solution>> solutions{
        ...
        {{2023, 9}, {{aoc::year2023::day09, ""}}},
        {{2023, 10}, {{aoc::year2023::day10, ""}}},
        {{2023, 11}, {{aoc::year2023::day11, ""}}},
        {{2023, 12}, {{aoc::year2023::day12, ""}}},
        {{2023, 13}, {{aoc::year2023::day13, ""}}},
        {{2023, 14}, {{aoc::year2023::day14, ""}}},
        {{2023, 15}, {{aoc::year2023::day15, ""}}},
        {{2023, 16},
         {{aoc::year2023::day16, ""},
          {aoc::year2023::day16par_unseq, "par_unseq"}}},
        {{2023, 17}, {{aoc::year2023::day17, ""}}},
        {{2023, 18}, {{aoc::year2023::day18, ""}}},
        ...
        {{2025, 4}, {{aoc::year2025::day04, ""}}},
        {{2025, 5}, {{aoc::year2025::day05, ""}}},
        {{2025, 6}, {{aoc::year2025::day06, ""}}},
        {{2025, 7}, {{aoc::year2025::day07, ""}}},
    };
